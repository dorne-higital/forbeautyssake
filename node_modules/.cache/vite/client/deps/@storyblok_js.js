...
var O = (n) => new Promise((t, e) => {
  ...
  s.async = true, s.src = n, s.id = "storyblok-javascript-bridge", s.onerror = (r) => e(r), s.onload = (r) => {
    S.forEach((i) => i()), _ = true, t(r);
  }, document.getElementsByTagName("head")[0].appendChild(s);
});
var I = Object.defineProperty;
var P = (n, t, e) => t in n ? I(n, t, { enumerable: true, configurable: true, writable: true, value: e }) : n[t] = e;
...
var ct = class {
  ...
  constructor(t, e) {
    ...
    let s = t.endpoint || e;
    if (!s) {
      const o = new b().getRegionURL, c = t.https === false ? "http" : "https";
...
var R;
var $ = "https://app.storyblok.com/f/storyblok-v2-latest.js";
var dt = (n, t, e = {}) => {
  var c;
...
var gt = (n = {}) => {
  ...
  return t !== false && u && O($), R = new v(i.schema), i.resolver && E(R, i.resolver), a;
};
var E = (n, t) => {
  n.addNode("blok", (e) => {
    let s = "";
...
var ht = (n) => !n || !(n != null && n.content.some((t) => t.content || t.type === "blok" || t.type === "horizontal_rule"));
var ft = (n, t, e) => {
  let s = e || R;
  if (!s) {
    console.error(
