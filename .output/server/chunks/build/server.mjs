...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CpoSFqyp.mjs').then((m2) => m2.default || m2)
  }
];
...
const LazyFeatureBlocks = defineAsyncComponent(() => import('./feature-blocks-zsBIydfq.mjs').then((r) => r.default));
const LazyHeroMain = defineAsyncComponent(() => import('./hero-main-DS0xS-AB.mjs').then((r) => r.default));
const LazyMainNav = defineAsyncComponent(() => import('./main-nav-BmIUGMMR.mjs').then((r) => r.default));
const LazyNotificationBanner = defineAsyncComponent(() => import('./notification-banner-B9IoJos5.mjs').then((r) => r.default));
const LazyText1Col = defineAsyncComponent(() => import('./text-1-col-ChtpuEUA.mjs').then((r) => r.default));
const LazyTextImageSplit = defineAsyncComponent(() => import('./text-image-split-8h_6UKJ3.mjs').then((r) => r.default));
const LazyFeature = defineAsyncComponent(() => import('./Feature-CrzFYmPy.mjs').then((r) => r.default));
...
const layouts = {
  default: () => import('./default-DMnIo1eZ.mjs').then((m2) => m2.default || m2)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-LjdDELWd.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-VWfJ20i9.mjs').then((r) => r.default || r));
...
export { Pe as P, _export_sfc as _, useRouter as a, useRuntimeConfig as b, navigateTo as c, entry$1 as default, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useNuxtApp as u };
